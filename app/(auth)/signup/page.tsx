    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface border border-[#27272a] rounded-xl p-6">
          ...
          <p className="text-[#a1a1aa] text-sm mb-6">Start protecting your contracts today</p>
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-accent hover:bg-accent-hover text-white font-medium py-2.5 px-4 rounded-lg text-sm transition-colors"
            >
              Create account
            </button>
          </form>
          ...
          <button
            type="button"
            className="w-full bg-[#1a1a1a] hover:bg-[#27272a] border border-[#27272a] text-white font-medium py-2.5 px-4 rounded-lg text-sm transition-colors flex items-center justify-center gap-2"
          >
